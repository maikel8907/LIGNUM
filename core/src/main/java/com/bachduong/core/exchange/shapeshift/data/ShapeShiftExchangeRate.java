package com.bachduong.core.exchange.shapeshift.data;
...
import com.bachduong.core.util.ExchangeRateBase;
...
/**
 * An exchange rate is expressed as a ratio of a pair of {@link com.bachduong.core.coins.Value} amounts.
 */
