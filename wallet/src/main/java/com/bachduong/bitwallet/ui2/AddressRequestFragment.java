...
import com.bachduong.core.exceptions.UnsupportedCoinTypeException;
...
import com.bachduong.bitwallet.ui2.dialogs.CreateNewAddressDialog;
import com.bachduong.bitwallet.ui2.widget.AmountEditView;
...
import static com.bachduong.bitwallet.ExchangeRatesProvider.getRate;
...
public class AddressRequestFragment extends WalletFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // The onCreateOptionsMenu is handled in com.bachduong.bitwallet.ui.AccountFragment
        // or in com.bachduong.bitwallet.ui.PreviousAddressesActivity
    ...
    public void onAddressClick() {
        ...
        if (activity != null && activity instanceof MainActivity) {
            ((MainActivity) activity).registerActionMode(actionMode);
        }
    }
