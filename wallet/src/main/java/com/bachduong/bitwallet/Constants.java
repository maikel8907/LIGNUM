...
import com.bachduong.core.coins.AsiacoinMain;
import com.bachduong.core.coins.AuroracoinMain;
import com.bachduong.core.coins.BatacoinMain;
import com.bachduong.core.coins.BitcoinMain;
import com.bachduong.core.coins.BitcoinTest;
import com.bachduong.core.coins.BlackcoinMain;
import com.bachduong.core.coins.BurstMain;
import com.bachduong.core.coins.CanadaeCoinMain;
import com.bachduong.core.coins.CannacoinMain;
import com.bachduong.core.coins.ClamsMain;
import com.bachduong.core.coins.ClubcoinMain;
import com.bachduong.core.coins.CoinID;
import com.bachduong.core.coins.CoinType;
import com.bachduong.core.coins.DashMain;
import com.bachduong.core.coins.DigibyteMain;
import com.bachduong.core.coins.DigitalcoinMain;
import com.bachduong.core.coins.DogecoinMain;
import com.bachduong.core.coins.DogecoinTest;
import com.bachduong.core.coins.EguldenMain;
...
import com.bachduong.core.coins.MonacoinMain;
import com.bachduong.core.coins.NamecoinMain;
import com.bachduong.core.coins.NeoscoinMain;
import com.bachduong.core.coins.NovacoinMain;
import com.bachduong.core.coins.NuBitsMain;
import com.bachduong.core.coins.NuSharesMain;
import com.bachduong.core.coins.NxtMain;
import com.bachduong.core.coins.OKCashMain;
import com.bachduong.core.coins.ParkbyteMain;
...
//    public static final int SEED_ENTROPY_EXTRA = 256;
    ...
    // Tung Duong: change to extend more number of seed to 24 words
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            ...
            new CoinAddress(BitcoinTest.get(), new ServerAddress("btc-testnet-cce-2.coinomi.net", 15001),
                    new ServerAddress("btc-testnet-cce-1.coinomi.net", 15001)),
