...
public class BalanceFragment$$ViewBinder<T extends com.bachduong.bitwallet.ui.BalanceFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131558585, "field 'transactionRows' and method 'onItemClick'");
    target.transactionRows = finder.castView(view, 2131558585, "field 'transactionRows'");
    ...
    view = finder.findRequiredView(source, 2131558588, "field 'emptyPocketMessage'");
    ...
    view = finder.findRequiredView(source, 2131558586, "field 'accountExchangedBalance' and method 'onLocalAmountClick'");
    target.accountExchangedBalance = finder.castView(view, 2131558586, "field 'accountExchangedBalance'");
    view.setOnClickListener(
      new butterknife.internal.DebouncingOnClickListener() {
        @Override public void doClick(
          android.view.View p0
    ...
    view = finder.findRequiredView(source, 2131558587, "field 'connectionLabel'");
    target.connectionLabel = finder.castView(view, 2131558587, "field 'connectionLabel'");
  }
